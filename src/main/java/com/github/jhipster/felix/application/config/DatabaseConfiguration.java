...
@Configuration
@EnableJpaRepositories("com.github.jhipster.felix.application.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("com.github.jhipster.felix.application.repository.search")
